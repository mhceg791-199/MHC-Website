...
export default function HoldingsCircularCluster() {
  ...
  return (
    <div className="relative w-full md:w-2/3 flex justify-center items-center py-20">
      ...
      <div className="grid grid-cols-2 gap-5 px-5 sm:hidden w-full">
        {/* Main logo first */}
        ...
        {blocks.map((item, i) => (
          <div
            key={i}
            className="bg-white w-20 p-3 rounded-xl shadow-md flex flex-col gap-2 items-center justify-center"
          >
            <img
              src={item.img}
...
// export default function HoldingsCircularCluster() {
//   const radius = 180; // المسافة عن اللوجو الرئيسي

//   return (
//     <div className="relative w-2/3 flex justify-center items-center py-20">

//       {/* MAIN LOGO IN CENTER */}
//       <div className="relative z-20">
//         <div className="w-36 h-36 rounded-full bg-white shadow-xl
//                         border-4 border-[#C5A363] flex items-center justify-center">
//           <img
//             src="/images/mhc.jpg"
//             className="w-24 h-24 object-contain"
//             alt="Main Logo"
...
//         // توزيع دائري لكن بمسافة وعشوائية بسيطة
//         const randomOffset = Math.random() * 35 - 18; // يخلي الشكل عشوائي شويه
//         const x = (radius + randomOffset) * Math.cos(angle);
//         const y = (radius + randomOffset) * Math.sin(angle);
