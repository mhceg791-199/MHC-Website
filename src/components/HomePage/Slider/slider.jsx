      ...
      <div className="slider-wrapper">
        <div className="slider-track">
          {[...homeSlider, ...homeSlider].map((h, i) => (
            <div key={i} className="slide-card group">
              <img
                src={h.logo}
                alt={h.title}
                loading="lazy"
                decoding="async"
                className="slide-img group-hover:scale-110"
              />

              <div className="slide-title">{h.title}</div>

              <div className="slide-overlay group-hover:opacity-100">
                <h4 className="text-xl font-semibold text-mainGold mb-2">
                  {h.title}
                </h4>
