...
function MosaicRealState() {
  ...
  const firstSectionDetails = {
    ...
    text: [
      ...
      "This distinguished eleven-story tower, with a built-up area of 101,393 square feet, will continue its legacy as an exclusive, top-tier administrative center, celebrated for its architectural distinction and unrivaled location. Bolstered by its pivotal role within the renowned MHC Group, Mosaic Real Estate Holding gains access to unparalleled resources and expertise, positioning the company to steward this iconic property with excellence and vision.",
    ],
