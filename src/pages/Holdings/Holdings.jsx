...
// import IndustrySlider from "../../components/IndustryPage/IndustrySlider/IndustrySlider";
...
function HoldingsPage() {
  ...
  return (
    <>
      <Navbar />
      <FirstSectionByVideo videoSrc={video} fallbackImg={fallback} title="Holdings"/>
      <HoldingsAbout />
      <HoldingsSection/>
      {/*
      <IndustrySlider /> */}
